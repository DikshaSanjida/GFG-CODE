<h2><a href="https://www.geeksforgeeks.org/problems/smallest-distant-window3132/1?_gl=1*6fq55s*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw_dbABhC5ARIsAAh2Z-Rol9J0rJ19ziW7gHuKNKW7tSib6yk85LxLjCNvhhafL_IWGiZbL7MaAqIaEALw_wcB&gbraid=0AAAAAC9yBkD0SZlW_OyYyowABQ1ua58aO">Smallest distinct window</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a string&nbsp;<strong>str,</strong>&nbsp;your task is to find the&nbsp;<strong>length</strong>&nbsp;of the&nbsp;<strong>smallest&nbsp;</strong>window that contains<strong>&nbsp;all&nbsp;</strong>the characters of the given string at least once.</span></p>
